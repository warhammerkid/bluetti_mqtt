...
class AC60(BluettiDevice):
    def __init__(self, address: str, sn: str):
        ...
        self.struct.add_decimal_field('battery_voltage',6003,2)
        ...
        self.struct.add_decimal_field('battery_voltage',6111,2)
        self.struct.add_uint_field('battery_percent',6113)
